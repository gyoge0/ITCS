...
public class Calculator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
            "Subtraction: " + value1 + " - " + value2 + " = " + subtract(value1, value2));
        System.out.println(
            "Multiplication: " + value1 + " * " + value2 + " = " + multiply(value1, value2));
        ...
        System.out.println(
            "Pythagorean: for c = " + value1 + " and a = " + value2 + " then b = " + pythagorean(
                value1, value2));
