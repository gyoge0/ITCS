...
public class StudentsAndBooks {
    ...
    public static void main(String[] args) {
        ...
        for (int robotClassIsPoorlyImplemented = 0;
            robotClassIsPoorlyImplemented < 5;
            robotClassIsPoorlyImplemented++) {
            lisa.move();
        }
        ...
        for (int danceLikeYourLifeDependsOnIt = 0;
            danceLikeYourLifeDependsOnIt < 100;
            danceLikeYourLifeDependsOnIt++) {
            myJobIsPointless.turnLeft();
        }
